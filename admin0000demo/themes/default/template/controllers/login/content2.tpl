...
<div id="login-panel">
	<div id="login-header">
		<h1 class="text-center">
			<img class="logo" src="/klido/img/klido-profesjonalne-srodki-czyszczace-logo-1603226311.jpg" alt=" KLIDO Sp. z o.o">
		</h1>
	...
	<style>
		.bootstrap #login {
			min-height: 100%;
			padding-bottom: 45px;
			background: url(../themes/classic/assets/images/bg-top.png) white no-repeat top center;
