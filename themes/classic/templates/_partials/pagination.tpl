...
<nav class="pagination">
  <div class="flex-row-center flex-just--center pagination--sum">
  ...
  <div class="flex-row-center">
    {block name='pagination_page_list'}
     {if $pagination.should_be_displayed}
        <ul class="page-list-pagination flex-row-center flex-just--center">
          {foreach from=$pagination.pages item="page"}


            <li class="{if $page.current}current{/if} {if $page.type === 'previous'}prev{elseif $page.type === 'next'}next{else}nofollow{/if}">
                <a
