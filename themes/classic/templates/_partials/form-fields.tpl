...
{*$field|dump*}
  ...
  {if $field.name != 'alias' && $field.name != 'address2' && $field.name != 'postcode2' && $field.name != 'phone'}



  <div class="form-group row {if !empty($field.errors)}has-error{/if} {if $field.type === 'checkbox'} row--ck{/if} {if $field.name == 'id_country' || $field.name == 'postcode2'} hide {/if} {if $field.name == 'postcode' || $field.name == 'city' || $field.name == 'firstname' || $field.name == 'lastname'  || $field.name == 'company' || $field.name == 'vat_number'} row--half{/if}">
    {if $field.type !== 'checkbox' && $field.name !== 'id_gender'}
    ...
    <div class="form-control-input {if ($field.type === 'radio-buttons')} form-control-valign flex-row-center{/if}">
        ...
        {block name='form_field_item_checkbox'}
          <div class="custom-checkbox">
            <label>
              ...
              <span class="ck--label">{$field.label nofilter}</span>
            </label>
          </div>
        {/block}
