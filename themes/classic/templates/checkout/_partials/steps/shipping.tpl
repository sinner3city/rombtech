    ...
    {if $delivery_options|count}
      ...
      >
          ...
          {block name='delivery_options'}
            <div class="delivery-options">
              {foreach from=$delivery_options item=carrier key=carrier_id}
                  <div class="delivery-radio flex-row-left delivery-option flex-wrap">
                    ...
                    <label for="delivery_option_{$carrier.id}" class="delivery-carrier delivery-option-2">
                      <div class="flex-row-left-mid flex-wrap">
                        <div class="">
                          <div class="flex-row-center-mid flex-wrap">
                            {if $carrier.logo}
        ...
        <div class="order-options">
          <div id="delivery">
            <p class="del-label">Dodaj informacje do swojego zamówienia jeżeli chcesz przekazać ważne dla Ciebie informacje.</p>
            <label for="delivery_message"></label>
            <textarea rows="2" cols="120" id="delivery_message" name="delivery_message" placeholder="opcjonalnie">{$delivery_message}</textarea>
          </div>
