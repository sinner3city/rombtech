...
<section id="order-summary-content" class="page-content page-order-confirmation">
  <div class="row">
    <div class="col-md-12">
      <h4 class="h4 black h4-check-title">{l s='Please check your order before payment' d='Shop.Theme.Checkout'}</h4>
    </div>
  </div>

  <div class="row sumedit-address">
    <div class="col-md-12">
      <h4 class="h4">
  ...
  <div class="row sumedit-carrier">
    <div class="col-md-12">
      ...
      <div class="col-md-12 summary-selected-carrier">
        <div class="row flex-row-center-mid flex-wrap">
          <div class="">
