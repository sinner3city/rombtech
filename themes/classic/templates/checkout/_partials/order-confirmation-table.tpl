...
<div id="order-items" class="col-md-12">
  <div class="row">
    <div class="flex-row order-table-header">
      {block name='order_items_table_head'}
        {* <h3 class="card-title h3 col-md-6 col-12">{l s='Order items' d='Shop.Theme.Checkout'}</h3> *}
        <h3 class="card-title h3 col-md-6 col-12 cp1">Podsumowanie</h3>
      ...
      <!-- <h3 class="card-title h3 col-md-2 text-md-center _desktop-title">{l s='Quantity' d='Shop.Theme.Checkout'}</h3> --> *}
        <h3 class="card-title h3 col-md-2 _desktop-title order-items-last-col">
          {l s='Total products' d='Shop.Theme.Checkout'}</h3>
      {/block}
    </div>
  </div>
  ...
  <div class="order-confirmation-table">
    ...
    {block name='order_confirmation_table'}
      {foreach from=$products item=product}
        <div class="order-line flex-wrap">
          ...
          <div class="details">
            {if $add_product_link}<a href="{$product.url}" target="_blank">{/if}
              <p><strong>{$product.name}</strong> <small class="sumqty">({$product.quantity}&nbsp;szt.)</small></p>
          ...
          <div class="row flex-row-mid  div-price">
            {* <!-- <div class=""> --> *}
      ...
      <table>
        ...
        <tr class="hide">
          <td>{l s='%label%:' sprintf=['%label%' => $subtotals.tax.label] d='Shop.Theme.Global'}</td>
