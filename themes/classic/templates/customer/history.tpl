    ...
    <table class="table table-striped table-bordered table-labeled hidden-sm-down">
      ...
      <tbody>
        {foreach from=$orders item=order}
          <tr>
            <th scope="row">
              <a href="{$order.details.details_url}" class="div-nr" data-link-action="view-order-details">{$order.details.reference}</a></th>
            ...
            <td class="text-sm-center hidden-md-down hide">
            ...
            <td class="text-sm-center order-actions">
              <a href="{$order.details.details_url}" class="details-history-press" data-link-action="view-order-details">
