...
<section class="section section-products products--new hide clearfix mt-3">
  {hook h='displayHomeBeforeProducts'}
  
  <h3 class="section-products__title">
    <strong class="cp3">Nowe produkty</strong><br>poznaj jako pierwszy
    <!-- <span class="titleLeft">Wyprzedaż</span> -->
  </h3>



    <div class="art__list list--products list--new" data-style="1" data-col="4" data-slider="true">
    ...
    <h2>col2</h2>
    <div class="art__list list--products list--new" data-style="1" data-col="2">
    ...
    <h2>col3</h2>
    <div class="art__list list--products list--new" data-style="1" data-col="3">
    ...
    <h2>col4</h2>
    <div class="art__list list--products list--new" data-style="1" data-col="4">
    ...
    <h2>col6</h2>
    <div class="art__list list--products list--new" data-style="1" data-col="6">
