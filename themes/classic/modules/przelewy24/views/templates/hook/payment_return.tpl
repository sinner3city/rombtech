...
<div class="p24-payment-return-page przelewy-24 t-center">
    ...
    {if 'ok' === $status}
        <p>{l s='Wybierz kanał płatności i opłać zamówienie' mod='przelewy24'}
        ...
        {if $P24_PAYMENT_METHOD_LIST}
            {if $p24_paymethod_graphics}
                ...
                <p class="pd-t-30">
                    {l s='Możesz także zapłacić na raty' mod='przelewy24'}:
                </p>


                <div class="pay-method-list pay-method-graphics pay-method-list-first pd-b-30">
        ...
        <form action="{$p24_url}" method="post" id="przelewy24Form" name="przelewy24Form" accept-charset="utf-8">
            ...
            {if $extracharge > 0 }
                ...
                <input type="hidden" name="extrachargeReturnFormatted" id="extrachargeReturnFormatted"
                    value="{$extrachargeFormatted}">
                <input type="hidden" name="extracharge_text" id="extracharge_text"
                    value="{l s="Extracharge Przelewy24" mod='przelewy24'}">
            {/if}
            ...
            {if $accept_in_shop}
                <div class="p24-accept-container">
            ...
            {if $payment_method_selected_id > 0}
                <button {$submitButtonDisabled} id="submitButton" data-text-oneclick="{l s='Pay by OneClick' mod='przelewy24'}"
                    onclick="formSend();" class="btn btn-primary">{l s='Pay' mod='przelewy24'}</button>
            ...
            {else}
                <button {$submitButtonDisabled} id="submitButton" data-text-oneclick="{l s='Pay by OneClick' mod='przelewy24'}"
                    onclick="formSend();" class="btn btn-primary">{l s='Pay by Przelewy24' mod='przelewy24'}</button>
            {/if}
        </form>
        {if !isset($p24_blik_code)}
            <p class="p24-small-text hide">
