...
<section class="contact-form">
  <form class="contact-us" action="./13-kontakt-z-nami" method="post"
    ...
    {if !$notifications || $notifications.nw_error}
      <section class="form-fields">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6  form-control-input">
            <input class="form-control" name="from" type="email" value="{$contact.email}"
        ...
        {if $contact.allow_file_upload}
          <div class="form-group row">
            ...
            <div class="col-md-6  form-control-input">
              ...
              <div>{l s='optional' d='Shop.Forms.Help'}</div>
            </div>
          </div>
        {/if}
        ...
        <div class="form-group row">
          ...
          <div class="col-md-9 form-control-input">
            <textarea class="form-control" name="message" placeholder="{l s='How can we help?' d='Shop.Forms.Help'}"
      ...
      <footer class="form-footer text-sm-right">
        ...
        <input class="btn btn-primary" type="submit" name="submitMessage"
          value="{l s='Wyślij wiadomość' d='Shop.Theme.Actions'}">
      </footer>
    {/if}
