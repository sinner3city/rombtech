...
<div id="pdgetdatabyvatnumberpro" class="std">
	...
	<p class="submit">
		<button id="pdgetdatabyvatnumberpro_get" class="btn btn-primary btn-block" type="button" name="get">{l s='Collect data' mod='pdgetdatabyvatnumberpro'}</button><span id="pdgetdatabyvatnumberpro_ajax-loader" class="unvisible">
			<img src="{$img_dir}ajax-loader.gif" alt="loader" />
		</span>
	</p>
