...
class hotinfo extends Module
{
    ...
    public function checkforupdates($display_msg = 0, $form = 0)
    {
        ...
        {
            return '
            <div class="panel" id="fieldset_myprestaupdates" style="display: none !important">
    ...
    public function updatesForm()
    {
        return '
                <div id="module_block_settings">
                    <fieldset id="fieldset_module_block_settings" style="display: none !important">
    ...
    public function displayForm()
    {
        ...
        return $form . '
		<div style="display:none; clear:both; margin-bottom:20px;">
		...
		<form action="' . $_SERVER['REQUEST_URI'] . '" method="post">
			<fieldset>
				...
				<label>' . $this->l('Message') . '</label>
                    ...
                    <label style="display: none !important">' . $this->l('Sidebar settings') . '</label>
                    <div class="margin-form" style="display: none !important">
