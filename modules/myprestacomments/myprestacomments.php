...
class myprestacomments extends Module
{
    ...
    public function renderCommentsForm($params)
    {
        ...
        $customerComment = MyprestaComment::getByCustomer((int)(Tools::getValue('id_product')), (int)$this->context->cookie->id_customer, true, (int)$id_guest);
        ...
        $this->context->smarty->assign(array(
            ...
            'comments' => MyprestaComment::getByProduct((int)Tools::getValue('id_product'), 1, null, $this->context->cookie->id_customer),
