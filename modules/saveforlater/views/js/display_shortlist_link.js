...
$(window).on('load', function () {
    // console.log($('.sfl_shorlist_large_link:contains("Dodany")').length)
    $('.sfl_shorlist_large_link:contains("Dodany")').addClass('added');

    $(document).on('click','.sfl_shorlist_large_link span', function () {
