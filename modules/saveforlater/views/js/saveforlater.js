...
//    // changes by rishabh
    //$('input[name="kb_sfl_config[recently_view]"]').append('<div class="vss_demo_block2">');
    $('.free-disabled').append($('.vss_overlay_paid1'));
    $('.free-disabled').hover(function () {
    ...
    //$('input[name="kb_sfl_config[recommendation][enable]"]').append('<div class="vss_demo_block3">');
    $('.free-disabled2').append($('.vss_overlay_paid3'));
    $('.free-disabled2').hover(function () {
        if ($('.vss_overlay_paid3').is(':visible')) {
            $('.vss_demo_block3').removeClass('vss_demo_block_hovered2');
            $('.vss_overlay_paid3').hide();
        } else {
            $('.vss_demo_block3').addClass('vss_demo_block_hovered2');
