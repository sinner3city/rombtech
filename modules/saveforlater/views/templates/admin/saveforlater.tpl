                                            ...
                                            <div class="tab-content even-height">
                                                ...
                                                <div id="tab_general_settings" class="tab-pane active">
                                                    ...
                                                    <div class="block">
                                                                ...
                                                                <div class="widget-body">
                                                                    <table class="form">
                                                                        ...
                                                                        <tr  class="free-disabled-text">
                                                                            ...
                                                                            <td class="settings">
                                                                                <input type="text" class="color-input" style="background-color: {$kb_sfl_config['general']['border_color']|escape:'htmlall':'UTF-8'}"  value='{$kb_sfl_config['general']['border_color']|escape:'htmlall':'UTF-8'}' disabled=""/>
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="free-disabled-text">
                                                                            ...
                                                                            <td class="settings">
                                                                                <input type="text" class="color-input buy-preview"  style="background-color: {$kb_sfl_config['general']['buy_color']|escape:'htmlall':'UTF-8'}" value='{$kb_sfl_config['general']['buy_color']|escape:'htmlall':'UTF-8'}' disabled=""/>
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr class="free-disabled-text">
                                                                            ...
                                                                            <td class="settings">
                                                                                <input type="text" class="color-input" style="background-color: {$kb_sfl_config['general']['bar_color']|escape:'htmlall':'UTF-8'}"  value='{$kb_sfl_config['general']['bar_color']|escape:'htmlall':'UTF-8'}' disabled=""/>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                                                            ...
                                                                                            <ul class="font-options-list">
                                                                                                ...
                                                                                                <li class="font-style">
                                                                                                    <div class="style-options font-color-option velocity-color-picker">
                                                                                                        <div class="color-display" style="background-color:#134baa"></div>
                                                                                                        <input type="hidden"  value="#134baa"/>
                                                                                                    </div>    
                                                                                                </li>
                                                                                            </ul>                                                                        
                                                                                        </div>                                                                
                                                                    ...
                                                                    <table class="form">
                                                                        <tr>
                                                                            ...
                                                                            <td class="settings">
                                                                                        ...
                                                                                        <div class="make-switch" data-on="primary" data-off="default">
                                                                                            <input class="make-switch" type="checkbox" value="1" id="recently_viewed_enable" disabled/>
                                                                                        </div>
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="settings">
                                                                                <div class="">
                                                                                    <input style="width:100px" type="text" class="text-width required-entry validate-integer" value="5" readonly=""/>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                        ...
                                                        <div class="block free-disabled2">
                                                            <div class="widget">
                                                                <div class="widget-head">
                                                ...
                                                <div id="tab_recommend_opt" class="tab-pane">
                                                    <div class="block">
                                                        <h4 id="analysis_report_heading" class="tab-heading heading-mosaic">
                                                            ...
                                                            <div class="topbuttons">
                                                                <button type="button" id="save_rec" class="btn btn-success sfl-sv-btn" disabled="">{l s='Save Recommendation Options' mod='saveforlater'}</button>
                                                            </div>
                                                        </h4>
                                                        <div class="block">
...
<br>
<br>
<a target="_blank" class="vss_free_version_link3" href="https://www.knowband.com/prestashop-advanced-wish-list">
<span class="vss_free_version_button2">{l s='Buy Now' mod='saveforlater'}</span>
</a>
                               </div>
{*
